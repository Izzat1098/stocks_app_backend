...
class InvestSummaryCreate(BaseModel):
    curr_date: Optional[str] = Field(None, description="Date of the investment summary in YYYY-MM-DD format")
    ...
    invest: Optional[str] = Field(None, max_length=50, description="Investment decision")
    investment_reasoning: Optional[str] = Field(None, max_length=500, description="Investment reasoning")
